...
//        List<BusNodeVO> sBusNodeList = utils.readCsv(BusNodeVO.class, "csvs/METRO-SEB-NODE-INFO.csv");
        List<BusNodeVO> sBusNodeList = utils.readCsv(BusNodeVO.class, "bus/METRO-GGDB-NODE-INFO.csv");
            ...
            IntStream.range(0, busNodeVOS.size()).forEach( i -> {
                ...
                try {
                    if(i != (busNodeVOS.size() - 1)){
                        ...
                        if(i%1000 == 0) System.out.println(i+"/"+sBusNodeList.size());
        ...
        CSVWriter writer = new CSVWriter(new FileWriter("d:/METRO-GGDB-NODE-INFO-TOBE.csv"));
